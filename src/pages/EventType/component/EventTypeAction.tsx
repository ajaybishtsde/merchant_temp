...
import EventTypeCU from './EventTypeCU';
...
const EventTypeAction: React.FC<EventTypeProps> = ({ data, fetchEventType }) => {
    ...
    const handleDeleteEventType = () => {
        EventTypeAPI.delete(data.id).then(() => {
...
export default EventTypeAction;
