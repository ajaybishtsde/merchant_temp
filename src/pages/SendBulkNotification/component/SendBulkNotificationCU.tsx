...
import {
  NewSendBulkNotification,
  SendBulkNotificationAPI,
} from '@/utils/api/send-bulk-notification.api';
import {
...
const SendBulkNotificationCU: React.FC<SendBulkNotificationCUProps> = ({
  isOpen,
  toggleModal,
  fetchLatestData,
}) => {
  const {
    ...
    control,
    watch,
  } = useForm<NewSendBulkNotification>({});
  ...
  const handleConfirmSubmit = async (idempotencyKey: string) => {
    ...
    try {
      ...
      const formData: NewSendBulkNotification = {
        ...
        ...(selectedType === 'GROUP' && {
          notificationGroupId: pendingFormData.notificationGroupId,
        }),
      };
    ...
    <div className="container mx-auto rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      {pendingFormData && (
        <ConfirmModel
          ...
          notificationData={pendingFormData}
          isSending={isSending}
        />
      )}
        ...
        <div className="w-full p-4">
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="mb-4">
              ...
              <SwitchInput initialValue={isMultiLanguage} onChange={(e) => setIsMultiLanguage(e)} />
            </div>
              ...
              <div className="flex items-center gap-4 mb-4">
                {languages.map((lang) => (
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <label key={lang.code}>{lang.label}</label>
                  </div>
                ))}
              </div>
            )}
              ...
              <>
                <div className="mb-4">
                  <label className="mb-2.5 block font-medium">
                    Enter Notification Title - Japanese
                  </label>
                  <input
                    type="text"
                    placeholder="Enter Notification Title"
                  ...
                  {errors.title_ja && (
                    <div className="text-sm text-red-600">
                      Notification Title in Japanese is required
                    </div>
                  )}
                </div>
                <div className="mb-4">
                  <label className="mb-2.5 block font-medium">
                    Enter Notification Message - Japanese
                  </label>
                  <textarea
                    placeholder="Enter Notification Message"
                  ...
                  {errors.message_ja && (
                    <div className="text-sm text-red-600">
                      Notification Message in Japanese is required
                    </div>
                  )}
                </div>
              </>
            ...
            {selectedLangs.includes('zh') && (
              <>
                <div className="mb-4">
                  <label className="mb-2.5 block font-medium">
                    Enter Notification Title - Chinese
                  </label>
                  <input
                    type="text"
                    placeholder="Enter Notification Title"
                  ...
                  {errors.title_zh && (
                    <div className="text-sm text-red-600">
                      Notification Title in Chinese is required
                    </div>
                  )}
                </div>
                <div className="mb-4">
                  <label className="mb-2.5 block font-medium">
                    Enter Notification Message - Chinese
                  </label>
                  <textarea
                    placeholder="Enter Notification Message"
                  ...
                  {errors.message_zh && (
                    <div className="text-sm text-red-600">
                      Notification Message in Chinese is required
                    </div>
                  )}
                </div>
              </>
            ...
            {selectedLangs.includes('es') && (
              <>
                <div className="mb-4">
                  <label className="mb-2.5 block font-medium">
                    Enter Notification Title - Spanish
                  </label>
                  <input
                    type="text"
                    placeholder="Enter Notification Title"
                  ...
                  {errors.title_zh && (
                    <div className="text-sm text-red-600">
                      Notification Title in Spanish is required
                    </div>
                  )}
                </div>
                <div className="mb-4">
                  <label className="mb-2.5 block font-medium">
                    Enter Notification Message - Spanish
                  </label>
                  <textarea
                    placeholder="Enter Notification Message"
                  ...
                  {errors.message_es && (
                    <div className="text-sm text-red-600">
                      Notification Message in Spanish is required
                    </div>
                  )}
                </div>
              </>
            ...
            <div className="mb-4">
              ...
              {errors.type && <div className="text-sm text-red-600">Type is required</div>}
            </div>
            ...
            {type == 'SINGLE' && (
              <div className="mb-4">
                ...
                {errors.singleUser && <div className="text-sm text-red-600">User is required</div>}
              </div>
            )}
            ...
            <div className="mb-4">
              ...
              <SwitchInput initialValue={isLink} onChange={(e) => setIsLink(e)} />
            </div>
            ...
            {isLink && hotspotType === 'place' && (
              <div>
                ...
                {errors.hotspot && <div className="text-sm text-red-600">Place is required</div>}
              </div>
            )}
            {isLink && hotspotType === 'event' && (
              <div>
                ...
                {errors.hotspot && <div className="text-sm text-red-600">Event is required</div>}
              </div>
            )}

            <div className="mb-4">
              <label className="mb-2.5 block font-medium">Is Stored</label>
              <SwitchInput initialValue={isStored} onChange={(e) => setIsStored(e)} />
            </div>
