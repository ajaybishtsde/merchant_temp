...
const InterestList = () => {
  ...
  const handleFilterChange = <K extends keyof FilterInterestQuery>(
    name: K,
    value: FilterInterestQuery[K],
  ) => {
      ...
      <div>
        ...
        <div className="w-full h-full">
          ...
          <div className="relative z-1 -mt-4">
            {state?.count > 0 && <Pagination getRequestData={fetchInterests} total={state.count} />}
          </div>
        </div>
      </div>
    </DefaultLayout>
