...
const OpenTo = () => {
  ...
  return (
    <DefaultLayout>
      {isAddOpenTo && (
        <OpenToCU isOpen={isAddOpenTo} toggleModal={toggleModal} fetchLatestData={fetchOpenTo} />
      )}
      <div>
        ...
        <div className="w-full h-full">
          ...
          <div className="relative z-1 -mt-4">
            {openTo?.count > 0 && <Pagination getRequestData={fetchOpenTo} total={openTo.count} />}
          </div>
        </div>
      </div>
    </DefaultLayout>
