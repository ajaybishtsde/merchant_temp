...
const AdminMessageCU: React.FC<AdminMessageCUProps> = ({
  isOpen,
  toggleModal,
  fetchLatestData,
  updateData,
      ...
      <BaseModal isOpen={isOpen} toggleModal={toggleModal} heading="App Password">
        <div className="w-full p-4">
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="mb-6">
              <label className="mb-2.5 block font-medium">Message</label>
              ...
              {errors.message && <div className="text-sm text-red-600">Message is required</div>}
            </div>
