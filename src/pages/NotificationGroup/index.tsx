...
import { INotificationGroup, NotificationGroupAPI, NotificationGroupResponse } from '@/utils/api/notification-group.api';
...
const NotificationGroup = () => {
    ...
    const colDefs: any = [
        ...
        },
        {
            ...
            sortable: true,
            cellRenderer: (params: { data: INotificationGroup }) => {
                return <NotificationGroupAction data={params.data} fetchNotificationGroup={fetchNotificationGroup} />;
            },
        },
    ];
    return (
