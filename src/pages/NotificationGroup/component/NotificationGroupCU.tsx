...
import { INotificationGroup, NewNotificationGroup, NotificationGroupAPI } from '@/utils/api/notification-group.api';
...
const NotificationGroupCU: React.FC<NotificationGroupCUProps> = ({ isOpen, toggleModal, fetchLatestData, updateData }) => {
    const { register, handleSubmit, formState: { errors }, control } = useForm<NewNotificationGroup>({
                ...
                <div className="w-full p-4">
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className="mb-4">
                            ...
                            />
                            {errors.name && (
                                <div className="text-sm text-red-600">Group Name is required</div>
                            )}
                        </div>
