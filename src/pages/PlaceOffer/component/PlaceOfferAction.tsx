...
import PlaceOfferCU from './PlaceOfferCU';
import { IPlaceOffer, PlaceOfferAPI } from '@/utils/api/place-offer.api';

interface PlaceOfferProps {
    data: IPlaceOffer;
    fetchPlaceOffer: () => void;
}

const PlaceOfferAction: React.FC<PlaceOfferProps> = ({ data, fetchPlaceOffer }) => {
    ...
    const handleDeletePlaceOffer = () => {
        PlaceOfferAPI.delete(data.id).then(() => {
...
export default PlaceOfferAction;
