...
const ReportList = () => {
  ...
  const handleFilterChange = <K extends keyof FilterReportQuery>(name: K, value: FilterReportQuery[K]) => {
  ...
  const colDefs: any = [
    ...
    {
      field: 'createdAt', headerName: 'Reported Date', flex: 1, sortable: true, valueFormatter: (params: any) => {
      ...
      <div>
        ...
        <div className="w-full h-full">
          ...
          <div className='relative z-1 -mt-4'>
            {report?.count > 0 &&
              <Pagination getRequestData={fetchReports} total={report.count} />
            }
          </div>
        </div>
