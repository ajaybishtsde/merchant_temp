...
import CountryCU from './CountryCU';
import { CountryAPI, ICountry } from '@/utils/api/country.api';
...
const CountryAction: React.FC<CountryProps> = ({ data, fetchCountry }) => {
    ...
    const handleDeleteCountry = () => {
        CountryAPI.delete(data.id).then(() => {
