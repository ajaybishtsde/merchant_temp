...
const AppVersionCU: React.FC<AppVersionCUProps> = ({ isOpen, toggleModal, fetchLatestData, updateData }) => {
    const { register, handleSubmit, formState: { errors } } = useForm<NewAppVersion>({
    ...
    const [isForceUpdateRequire, setIsForceUpdateRequire] = useState(updateData?.isForceUpdateRequire ?? false)
                ...
                <div className="w-full p-4">
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className="mb-4">
                            ...
                            {errors.platform && (
                                <div className="text-sm text-red-600">Platform is required</div>
                            )}
                        </div>
                        ...
                        <div className="mb-4">
                            ...
                            />
                            {errors.version && (
                                <div className="text-sm text-red-600">version is required</div>
                            )}
                        </div>
                        ...
                        <div className="mb-4">
                            ...
                            />
                            {errors.build && (
                                <div className="text-sm text-red-600">build is required</div>
                            )}
                        </div>
