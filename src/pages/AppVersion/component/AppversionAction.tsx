...
import AppVersionCU from './AppVersionCU';
...
const AppVersionAction: React.FC<AppVersionProps> = ({ data, fetchAppVersion }) => {
    ...
    const handleDeleteAppVersion = () => {
        AppVersionAPI.delete(data.id).then(() => {
...
export default AppVersionAction;
