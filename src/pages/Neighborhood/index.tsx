...
const NeighborhoodList = () => {
  ...
  const handleFilterChange = <K extends keyof FilterNeighborQuery>(name: K, value: FilterNeighborQuery[K]) => {
      ...
      <div>
        ...
        <div className="w-full h-full">
          ...
          <div className='relative z-1 -mt-4'>
            {state?.count > 0 &&
              <Pagination getRequestData={fetchEvents} total={state.count} />
            }
          </div>
        </div>
