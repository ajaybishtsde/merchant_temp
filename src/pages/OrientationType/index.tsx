...
import { IOrientationType, OrientationTypeAPI, OrientationTypeResponse } from '@/utils/api/orientationtype.api';
...
const OrientationType = () => {
    ...
    const colDefs: any = [
        ...
        },
        {
            ...
            sortable: true,
            cellRenderer: (params: { data: IOrientationType }) => {
                return <OrientationTypeAction data={params.data} fetchOrientationType={fetchOrientationType} />;
            },
        },
    ];
    return (
