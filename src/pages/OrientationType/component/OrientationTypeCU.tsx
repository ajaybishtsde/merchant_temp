...
import { IOrientationType, NewOrientationType, OrientationTypeAPI } from '@/utils/api/orientationtype.api';
...
const OrientationTypeCU: React.FC<OrientationTypeCUProps> = ({ isOpen, toggleModal, fetchLatestData, updateData }) => {
    const { register, handleSubmit, formState: { errors } } = useForm<NewOrientationType>({
