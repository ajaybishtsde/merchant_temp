  ...
  return (
    <div className="container mx-auto rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      <BaseModal
        ...
        heading={updateAdminData ? 'Update admin' : 'Add new admin'}
      >
        <div className="w-full">
          <div className="w-full p-4">
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="mb-4">
                <label className="mb-2.5 block font-medium">Last Name</label>
                <div className="relative">
                  <input
                    type="text"
              ...
              <div className="mb-4">
                <label className="mb-2.5 block font-medium">Date of Birth</label>
                <div className="relative">
                  <input
                    type="date"
