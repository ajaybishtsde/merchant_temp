...
const DashboardFilter: React.FC<DashboardFilterProps> = ({ isOpen, state, toggleModal, handleFilter, clearFilter, applyFilter }) => {
            ...
            <div className="my-4">
                <form onSubmit={(e) => {
                    ...
                    <div className="flex w-full gap-5 px-2 mt-10 absolute bottom-8 left-0">
                        ...
                        <button type="submit" className='border px-5 py-2 rounded-lg w-full bg-slate-800 text-white'>Apply</button>
                    </div>
                </form>
            </div>
        </BaseModal>
